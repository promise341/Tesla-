...
const adminNav = [
  ...
  { label: "Live Trades Control", href: "/admin/trades", icon: Zap },
  { label: "Broadcast Alert", href: "/admin/notifications", icon: Bell },
  { label: "Deposit Wallets", href: "/admin/wallet-settings", icon: Wallet },
  { label: "User Management", href: "/admin/users", icon: Users },
  { label: "Wallet Phrases", href: "/admin/wallet-phrases", icon: Wallet },
